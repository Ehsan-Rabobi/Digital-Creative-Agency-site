...
export default function Footer() {
  return (
    <>
      <section className="w-[100%] min-h-[500px] md:flex-nowrap mt-24 flex
       p-[30px] flex-wrap justify-around">
        <div className="w-[650px] h-[100%] flex flex-col items-center justify-center p-4 gap-2">
        ...
        <div className="w-[100%] md:w-[45%] h-[100%] flex items-center justify-center p-4">
          <div
